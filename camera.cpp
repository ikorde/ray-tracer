...
vec3 Camera::World_Position(const ivec2& pixel_index)
{
    ...
    result[0] = film_position[0] + horizontal_vector[0]*C[0] + vertical_vector[0]*C[1]; 
    result[1] = film_position[1] + horizontal_vector[1]*C[0] + vertical_vector[1]*C[1];
    result[2] = film_position[2] + horizontal_vector[2]*C[0] + vertical_vector[2]*C[1];
